...
namespace CRM.Migrations
{
    ...
    [Migration("20200414145048_User2")]
    partial class User2
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("CRM.Data.Entities.CRMUser", b =>
                {
            ...
            modelBuilder.Entity("CRM.Data.Entities.Process", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = "de48a720-5496-4d3c-bb15-b122ef6a6829",
                            Name = "Basic",
            ...
            modelBuilder.Entity("CRM.Data.Entities.Resource", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = "0ce1c541-8595-47e5-8706-c81297dc25f6",
                            Name = "Test"
                        });
                });
            ...
            modelBuilder.Entity("CRM.Data.Entities.Task", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = "7cd82fc3-5c49-4e9e-941f-849363ce3ddd",
                            IsChangeTime = true,
                            IsChangeUsers = true,
                            IsImportant = true,
                            IsStarted = false,
            ...
            modelBuilder.Entity("CRM.Data.Entities.TaskType", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = "27dbb4d5-f676-4991-b8df-14aa682442bc",
                            Name = "Base"
                        });
                });
            ...
            modelBuilder.Entity("CRM.Data.Entities.TaskUser", b =>
                {
                    b.HasOne("CRM.Data.Entities.CRMUser", "User")
                        .WithMany("Tasks")
                        .HasForeignKey("TaskId");
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityUserClaim<string>", b =>
                {
                    b.HasOne("CRM.Data.Entities.CRMUser", null)
                        .WithMany()
                        .HasForeignKey("UserId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
